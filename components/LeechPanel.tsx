 ...
 *
 * So the prompt *is* the editor — the thing §4 asks for is a rewrite, and an
 * alert that only told you to go and do one somewhere else would be an alert
 * you dismiss. Saving and dismissing both count as having read it, because in
 * both cases you have made the decision §4 wanted you to make.
 *
 * What it will not do is offer to suspend or delete the word. §4 rules both
 * out as automatic, and putting them behind this button would be the same
 * thing with an extra tap: the moment you have just failed a word six times is
 * the worst moment to decide you are done with it.
 */
